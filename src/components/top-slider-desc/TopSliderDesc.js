...
import s from "../top-slider/TopSlider.module.css";
import sd from "../top-slider-desc/TopSliderDesc.module.css";

const TopSliderDesc = () => {
  console.log("I am desc");
  return (
    <div className={sd.container}>
      <h1 className={classNames(s.title, sd.title)}>Why our Directory</h1>
      <div className={sd.innerContainer}>
        <div className={classNames(s.wrap, sd.wrap)}>
